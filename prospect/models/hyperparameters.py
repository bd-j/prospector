...
This class gets all all the ProspectorParams functionality, but it overrides the _prior_product and prior_transform methods
to sample the hyperparameters & log SFR ratios of the stochastic SFH prior.
"""
