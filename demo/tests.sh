...
python prospectr.py --param_file=demo_csphot_params.py --sptype=fsps --zcontinuous=1 --custom_filter_keys=filter_keys_threedhst.txt

#Parallel version of above
mpirun -np 4 python prospectr.py --param_file=demo_csphot_params.py --sptype=fsps --zcontinuous=1 --custom_filter_keys=filter_keys_threedhst.txt

#Infer multi-component CSP parameters from real (photometric) data using a script model descriptor
python prospectr.py --param_file=demo_multicsphot_params.py --sptype=fsps --zcontinuous=1 --custom_filter_keys=filter_keys_threedhst.txt
